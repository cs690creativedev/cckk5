                                ...
                                while (sdr.Read())
                                {
                                    if (sdr["Total Open"] != System.DBNull.Value)
                                    {
                                        Data.Add(new CLSA6
                                        {
                                            ...
                                            Total_Open = (int)sdr["Total Open"],
                                            Total_Sold = (int)sdr["Total Sold"],
                                            Total_Deferred = (int)sdr["Total Deferred"],
                                            Total_Lost_Price = (int)sdr["Total Lost Price"],
                                            Total_Lost_Comp = (int)sdr["Total Lost Comp"],
                                            Total_Lost_Other = (int)sdr["Total Lost Other"],
                                            Total = (int)sdr["Total"]
